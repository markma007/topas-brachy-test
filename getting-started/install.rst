...
-----------------------
Download the TOPAS-nBio extension and put in a separate directory (e.g. /PathToWorkDirectory/TOPAS-brachy). This path should not be inside the main TOPAS installation directory to avoid accidental loss of your extensions and parameter files when updating to a new TOPAS version. 
After building TOPAS link the TOPAS-brachy extension and rebuild the code::
 
	cmake -DTOPAS_EXTENSIONS_DIR=/PathToWorkDirectory/TOPAS-brachy
	make -j8 